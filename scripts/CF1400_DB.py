...
# Data storage
data_folder = 'D:\\TUD204860\\Desktop\\Scripts\\mjspylab-master\\data\\'
shared_folder = 'K:\\ns\\qt\\qt-shared\\sarsby\\web\\data\\cf1400\\'+attributes['series']+'\\'

# Save the state of the ivvi rack. Unfotunatally you have to enter this all by hand.
attributes['ivvi rack'] = {'Dac 1 output voltage gain V/V' : 10e-3,
                    'Voltage input gain V/V': 1000,
                    'Current input gain V/A': 10e6}
...
def setupFunction():
    ...
    return {'Keithley1 offset / V':devices['keithley1'].get_readnextval(),
            'Pressures' : readJSONtable_lastline('M:\\tnw\\ns\\qt\\qt-shared\\sarsby\\web\\CF1400\\fp.json'),
            'Temperatures' : readJSONtable_lastline('M:\\tnw\\ns\\qt\\qt-shared\\sarsby\\web\\CF1400\\avs.json'),
            }
